...
Here are the three things I think Trump has to do on day one to signal to the community that he is in fact the crypto president.`;
  ...
  const PINNED_RESPONSES = {
    ...
    'Why does the UX in crypto suck so bad?': {
      reply: "The UX in crypto can be frustrating, to say the least. There are a number of reasons for that which I\u2019ve observed first-hand.\n\nOne is, the technology is genuinely hard. Private keys, gas fees, network-specific addresses, smart contracts, nonces\u2026  I once saw a screen asking if I wanted to use the \u201cplasma exit mechanism\u201d for my transaction. This is complex technology with fundamentally unique concepts, and the more transparent a product is about what\u2019s happening under the hood, the more difficult it is for outsiders to understand.\n\nAnother is, crypto is a culture of hyper-intelligent, borderline autistic DIYers who pride themselves on self-reliance. So a lot of projects (especially in the early days) didn\u2019t even try to appeal to outsiders. I\u2019m thinking of the original Curve DAO UI.\n\nAnother reason is that the space moves at an incredibly fast pace and developers often prioritize functionality over user experience. I\u2019ve worked on plenty of features where the goal was to build an MVP and get it out the door quickly, rather than taking the time to refine the UX.\n\nLast but not least, the regulatory environment is still evolving and teams often run into legal issues when they try to improve user experience. For example, AML/KYC requires tons of data collection, creating lots of friction at onboarding. Because of different laws in different geographies, platforms have to limit or sometimes completely block things by region. Many DeFi primitives and non-custodial structures are not adequately accounted for by existing laws, which forces every team to make individual choices about how close they want to fly to the sun.\n\nThat being said, people do recognize the importance of UX in crypto and many companies prioritize user experience and design. As a product designer in the space, I\u2019ve had my share of frustrations with crypto UX, but I believe that despite the challenges we can and must find ways to make crypto more accessible and easy to use for everyone.",
      sourceIndices: [36, 50]
    }
  };
